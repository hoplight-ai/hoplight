          ...
          <div className="work-cards">
            ...
            <Link className="wcard" href="/persuasion">
              ...
              <div className="wcard-body">
                ...
                <p>Validated in a {FACTS.rct.n}-person {FACTS.rct.method}, {FACTS.rct.matchRate} matched to the voter file: up to {FACTS.rct.liftVsPlacebo} points over a placebo group who read an unrelated message. Persuasion you can audit, control, and improve.</p>
                <span className="wc-go">View &rarr;</span>
              </div>
            </Link>
          </div>
