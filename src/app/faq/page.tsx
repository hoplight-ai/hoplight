...
export const metadata: Metadata = {
  title: 'FAQ',
  description:
    'Frequently asked questions about AI governance, generative engine optimization, psychographic messaging, agentic AI systems, and AI consulting for labor unions and progressive organizations.',
  alternates: { canonical: 'https://hoplight.ai/faq' },
  openGraph: {
    title: 'FAQ | Hoplight',
    description:
      'AI governance, GEO, psychographic messaging, agentic systems, vendor audits, and ethical AI for progressive organizations.',
  ...
  return (
    <>
      ...
      <p className="subtitle">
        How AI governance, persuasion systems, and agentic operations work in
        practice.
      </p>
